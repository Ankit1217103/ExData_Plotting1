...
par(mfrow=c(2,2))
plot(SetDate$SetTime, SetDate$Global_active_power, type="l", col="green", xlab="", ylab="Global Active Power")
plot(SetDate$SetTime, SetDate$Voltage, type="l", col="orange", xlab="datetime", ylab="Voltage")
...
plot(SetDate$SetTime, SetDate$Global_reactive_power, type="l", col="blue", xlab="datetime", ylab="Global_reactive_power")
dev.off()
